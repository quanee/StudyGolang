...
func (bc *BlogCreate) SetNillableTitle(s *string) *BlogCreate {
	if s != nil {
		bc.SetTitle(*s)
	}
	return bc
...
func (bc *BlogCreate) SetNillableContent(s *string) *BlogCreate {
	if s != nil {
		bc.SetContent(*s)
	}
	return bc
...
func (bc *BlogCreate) defaults() {
	...
	if _, ok := bc.mutation.Content(); !ok {
		v := blog.DefaultContent
		bc.mutation.SetContent(v)
	}
}
